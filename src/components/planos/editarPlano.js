...
function EditarPlano(props) {
  ...
  const formik = useFormik({
      initialValues:{
        nome: JSON.parse(localStorage.getItem("plano")).nome,
        prazo: JSON.parse(localStorage.getItem("plano")).prazo,
        valor: JSON.parse(localStorage.getItem("plano")).valor,
        id: id
      },
      validationSchema:schema,
      onSubmit: values =>{
    instance().post("update_plano.php", values).then(()=>props.history.goBack());
      },
  });
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Card style={{padding:10, flex: 1, marginBottom: 10}}>
            <Card.Title  style={{alignSelf: 'center'}}>Editar o plano de estudos:</Card.Title>
            <Form onSubmit={formik.handleSubmit}>
                ...
                <Form.Group controlId="cadastro2">
                    <Form.Label>Prazo do plano</Form.Label>
