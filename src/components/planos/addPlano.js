...
function AddPlano(props) {
  ...
  useEffect(()=>{
    console.log("effect");
    instance().get("get_plano.php").then((result)=>{setPlanos(result.data); console.log(result.data)});
  },[]);
  ...
  const formik = useFormik({
      ...
      onSubmit: values =>{
          instance().post("insert_plano.php", values).then((result) => props.history.goBack());
      },
  });
