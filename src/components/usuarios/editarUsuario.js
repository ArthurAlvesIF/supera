...
function EditarUsuario(props) {
  ...
  const formik = useFormik({
      initialValues:{
        nome: JSON.parse(localStorage.getItem("usuario")).nome,
        email: JSON.parse(localStorage.getItem("usuario")).email,
        senha: '',
        telefone: JSON.parse(localStorage.getItem("usuario")).telefone,
        rua: JSON.parse(localStorage.getItem("usuario")).rua,
        numero: JSON.parse(localStorage.getItem("usuario")).numero,
        complemento: JSON.parse(localStorage.getItem("usuario")).complemento,
        bairro: JSON.parse(localStorage.getItem("usuario")).bairro,
        cidade: JSON.parse(localStorage.getItem("usuario")).cidade,
        estado: JSON.parse(localStorage.getItem("usuario")).estado,
        cep: JSON.parse(localStorage.getItem("usuario")).cep,
	      cpf: JSON.parse(localStorage.getItem("usuario")).cpf,
        id: id
      },
      validationSchema:schema,
      onSubmit: values =>{
        instance().post("update_usuario.php", values).then(()=>props.history.goBack());
      },
  });
...
<ExitToAppIcon style={{position: 'absolute', left: '92%', top: '50%',transform: 'translate(-50%, -50%)', fontSize: 40}} onClick={()=>{localStorage.clear(); history.push("/login"); }}/>
      ...
      <main className={classes.content}>
        ...
        <Card style={{padding:10, flex: 1, marginBottom: 10}}>
            <Card.Title  style={{alignSelf: 'center'}}>Editar o usuário:</Card.Title>
            ...
            <Form.Group controlId="cadastro">
                ...
                <Form.Group controlId="cadastro2">
